## 1. Implementation
- [ ] 1.1 Expand historical generation to full 30 days
...
- [ ] 1.2 Generate baseline external events
...
- [ ] 1.3 Build data loader for app startup
...
- [ ] 1.4 Update historical data endpoint
