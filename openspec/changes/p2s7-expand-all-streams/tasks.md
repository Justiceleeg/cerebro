## 1. Implementation
- [x] 1.1 Expand `StreamGenerator` to all 50 streams
...
- [x] 1.3 Expand historical generation to all streams
...
- [x] 1.4 Calculate baseline statistics for all streams
...
- [x] 1.5 Update WebSocket to stream all events
